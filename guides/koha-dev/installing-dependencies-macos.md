...
Windows users refer to [Installing dependencies - Windows 🦾🤖](/guides/koha-dev/installing-dependencies.md)

Linux users refer to [Installing dependencies - Linux 🦾🤖](/guides/koha-dev/installing-dependencies-linux.md)
:::
